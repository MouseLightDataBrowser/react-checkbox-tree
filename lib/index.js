...
var _nodeShape = __webpack_require__(5);
    ...
    */
		...
		value: function renderTreeNodes(nodes) {
			...
			var treeNodes = nodes.map(function (node, index) {
				...
				var checked = _this5.getCheckState(node);
				var children = _this5.renderChildNodes(node);
				...
				return _react2.default.createElement(
					_TreeNode2.default,
					{
						...
						icon: node.icon,
						label: node.label,
						optimisticToggle: _this5.props.optimisticToggle,
						rawChildren: node.children,
						treeId: _this5.id,
						value: node.value,
						onCheck: _this5.onCheck,
...
CheckboxTree.propTypes = {
	...
	checked: _propTypes2.default.arrayOf(_react2.default.PropTypes.string),
	expanded: _propTypes2.default.arrayOf(_react2.default.PropTypes.string),
	...
	_createClass(TreeNode, [{
		...
		value: function renderCollapseIcon() {
			if (!this.props.expanded) {
				return _react2.default.createElement('i', { className: 'rct-icon rct-icon-expand-close' });
			}

			return _react2.default.createElement('i', { className: 'rct-icon rct-icon-expand-open' });
		}
	}, {
